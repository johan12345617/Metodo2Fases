   ...
   $(function(){
    ...
    $("#jsx_solucion_pasos").accordion({collapsible:true});
   ...
   function jsx_resolver_matriz(ma,it,es,fa,check){
    var ma01=ma;
    var cont=$("#jsx_solucion_pasos");
    var iteracion=it;
   ...
   function jsx_ejemplo(){
    ...
    if(ej=="ej0"){
     ...
     var fo01=new jsx_funcionObjetivo('max',6,4,4);
     var re01=new jsx_restriccion(3,6,1,'<=',20);
     var re02=new jsx_restriccion(2,1,2,'=',15);
     jsx_pr=new jsx_problema();
     jsx_pr.setFuncionObjetivo(fo01);
     jsx_pr.addRestriccion(re01);
     jsx_pr.addRestriccion(re02);
